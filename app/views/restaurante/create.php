    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo BASE_URL; ?>restaurante/edit" class="btn btn-outline-secondary">
    ...
    <div class="row">
        <div class="col-lg-8 col-xl-9">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo BASE_URL; ?>restaurante/store" id="restaurantForm">
                        <div class="row">
                            <!-- Basic Information -->
                            <div class="col-md-6">
                                <div class="mb-3">
